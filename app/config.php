...
return [
    ...
    'middlewares' => [
        \DI\get(\Deshboard\Infrastructure\Http\Middleware\ErrorPageContent::class),
        \DI\get(\Middlewares\Whoops::class),
        \DI\get(\Deshboard\Infrastructure\Http\Middleware\HttpException::class),
   ...
   \Twig_Environment::class => \DI\object()->constructor(
    ...
    \Psr\Log\LoggerInterface::class => function (\Interop\Container\ContainerInterface $container) {
        $monolog = new \Monolog\Logger('Deshboard');
